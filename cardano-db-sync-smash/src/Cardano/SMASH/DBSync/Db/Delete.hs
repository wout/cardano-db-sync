...
deleteDelistedPool = panic "Cardano.SMASH.DBSync.Db.Delete.deleteDelistedPool"

{-
deleteDelistedPool :: MonadIO m => PoolIdent -> ReaderT SqlBackend m Bool
...
deleteRetiredPool = panic "Cardano.SMASH.DBSync.Db.Delete.deleteRetiredPool"

{-
deleteRetiredPool :: MonadIO m => PoolIdent -> ReaderT SqlBackend m Bool
